...
def creat_account():
    nom = session["new_account_nom"]= request.form["nom"]
    prenom = session["new_account_prenom"] = request.form["prenom"]
    e_mail = request.form["e_mail"]
    mot_de_passe= request.form["mot_de_passe"]
    classe = session["new_account_classe"] = request.form["classe"]
